...
public class ViolinSampler : MonoBehaviour
{
    public static ViolinSampler I;

    [Header("Resources path (under Assets/Resources/)")]
    public string resourcesFolder = "Sound/Violin";
    ...
    void LoadAllClips()
    {
        ...
        Debug.Log($"[ViolinSampler] Loaded {clipByName.Count} clips from Resources/{resourcesFolder}");
    }
